...
def fetch_metrics():
   ...
   ###TEMPO DE RESPOSTA
   time_response_request='http://20.84.71.186:9090/api/v1/query?query=irate(http_server_requests_seconds_sum{instance="11de-2804-431-c7db-7a1f-7ca6-8a98-d830-2734.ngrok.io:80", uri!~".*actuator.*"}[1m]) / irate(http_server_requests_seconds_count{instance="11de-2804-431-c7db-7a1f-7ca6-8a98-d830-2734.ngrok.io:80", uri!~".*actuator.*"}[1m])'
   time_response_register=requests.get(time_response_request).json()
   

   ##USO DE CPU
   cpu_usage_request='http://20.84.71.186:9090/api/v1/query?query=system_cpu_usage{instance="11de-2804-431-c7db-7a1f-7ca6-8a98-d830-2734.ngrok.io:80"}'
   cpu_usage_register=requests.get(cpu_usage_request).json()

   ###USO TOTAL DE MEMÓRIA
   memory_used_request='http://20.84.71.186:9090/api/v1/query?query=sum(jvm_memory_used_bytes{instance="11de-2804-431-c7db-7a1f-7ca6-8a98-d830-2734.ngrok.io:80"})*100/sum(jvm_memory_max_bytes{instance="11de-2804-431-c7db-7a1f-7ca6-8a98-d830-2734.ngrok.io:80"})'
   memory_used_register=requests.get(memory_used_request).json()

   ###USO DE MEMÓRIA HEAP
   heap_used_request='http://20.84.71.186:9090/api/v1/query?query=sum(jvm_memory_used_bytes{instance="11de-2804-431-c7db-7a1f-7ca6-8a98-d830-2734.ngrok.io:80", area="heap"})*100/sum(jvm_memory_max_bytes{instance="11de-2804-431-c7db-7a1f-7ca6-8a98-d830-2734.ngrok.io:80", area="heap"})'
   heap_used_register=requests.get(heap_used_request).json()

   ###USO DE MEMÓRIA NON-HEAP
   non_heap_used_request='http://20.84.71.186:9090/api/v1/query?query=sum(jvm_memory_used_bytes{instance="11de-2804-431-c7db-7a1f-7ca6-8a98-d830-2734.ngrok.io:80", area="nonheap"})*100/sum(jvm_memory_max_bytes{instance="11de-2804-431-c7db-7a1f-7ca6-8a98-d830-2734.ngrok.io:80", area="nonheap"})'
